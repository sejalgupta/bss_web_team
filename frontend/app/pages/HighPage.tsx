...
interface HighPageProps {
  onNavigate?: (path: string) => void
}

export default function HighPage({ onNavigate }: HighPageProps) {
  ...
  return (
    <div>
      ...
      <div className="bg-green-50 rounded-xl p-8 mb-8 text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">High School</h1>
      ...
      {loading ? (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading High School courses...</p>
          </div>
        </div>
        ...
        <div className="text-center py-12 bg-white border border-gray-200 rounded-lg">
          <p className="text-gray-500">No high school lessons available.</p>
        </div>
      )}
    </div>
  )
