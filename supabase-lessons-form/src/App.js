...
function App() {
  ...
  const handleJsonChange = (fieldName, value, isValid) => {
    setFormData(prev => ({
      ...prev,
      [fieldName]: value
    }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add optional fields (convert empty strings to null)
      ...
      const jsonFields = ['learning_objectives', 'materials', 'teaching_activities'];
      jsonFields.forEach(field => {
        if (formData[field]?.trim()) {
          const { parsed } = validateJson(formData[field]);
          if (parsed !== null) {
            submitData[field] = parsed;
          }
        }
      });
            ...
            <div className="section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group full-width">
                  ...
                  />
                  <small className="hint">Foreign key to users.id</small>
                </div>
              </div>
            </div>
